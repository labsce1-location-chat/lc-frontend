    ...
    render(){
        return(
            ...
            <View style={styles.container}>
                <Text>Enter Name of Chatroom</Text>
                <TextInput name="roomName" style={styles.textBox} onChangeText={this.handleChange.bind(this, "roomName")} value={this.state.roomName} maxLength={30} />
